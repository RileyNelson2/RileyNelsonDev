...
📍 Fort Collins, CO | Open to relocation

## WHAT I DO

*I build software that works for real users, with a focus on geospatial applications, data visualization, and collaborative development.*

**- ✅ Geospatial Application Development.**
I have hands-on experience building web applications that integrate spatial datasets, real-time sensor data, and interactive maps using React, TypeScript, Leaflet, and D3.js.

**- ✅ Full-Stack Web Development.**
From front-end interfaces to back-end databases, I build and maintain software across the stack using modern tools and frameworks in collaborative agile teams.

**- ✅ Data Analysis & Visualization.**
I enjoy turning complex datasets into clear, accessible, and actionable information for researchers, educators, and the public.
...
<table>
  <tbody>
    <tr>
      <td>📧</td>
      <td><a href="mailto:rlnelso@outlook.com">rlnelso@outlook.com</a></td>
    </tr>
    <tr>
      <td>📞</td>
      <td>(208) 559-0280</td>
    ...
    <tr>
      <td>💼</td>
      <td><a href="https://www.linkedin.com/in/riley-nelson-689222257">LinkedIn</a></td>
    </tr>
    <tr>
      <td>💻</td>
      <td><a href="https://github.com/RileyNelson2">GitHub</a></td>
    </tr>
  </tbody>
</table>
